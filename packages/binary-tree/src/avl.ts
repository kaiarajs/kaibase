import { ArrayDuplicate, DefaultCheckKeyEquality, DefaultCheckValueEquality, DefaultCompareKeysFunction } from "core/lib/utils";
...
export class AVLNode extends Node<AVLNode> implements IAVLNode {
     ...
     */
    public parent: AVLNode | null = null;
    /**
        ...
        while (true) {
            ...
            if (currentNode.compareKeys(currentNode.key, key) === 0) {
                if (currentNode.unique) {
                    ...
                    currentNode.value = ArrayDuplicate(currentNode.value.concat(value));
                }
                return this;
            }
    ...
    public _updateKey(key: ASNDBS, newKey: ASNDBS): AVLNode {
        ...
        if (currentNode.checkKeyEquality(key, currentNode.key)) {
            ...
            if (currentNode.unique) {
                ...
                // node was found
                if (matchedNode) {
                    matchedNode.value = ArrayDuplicate(matchedNode.value.concat(currentNode.value));
